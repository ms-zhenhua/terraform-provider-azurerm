...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=LoadDistributionPolicy -id=/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Network/applicationGateways/applicationGateway1/loadDistributionPolicies/policy1
