...
func (ApplicationInsightsStandardWebTestNewResource) Arguments() map[string]*pluginsdk.Schema {
...
func (ApplicationInsightsStandardWebTestNewResource) Attributes() map[string]*pluginsdk.Schema {
	return map[string]*pluginsdk.Schema{
...
func (ApplicationInsightsStandardWebTestNewResource) ModelObject() interface{} {
	return &ApplicationInsightsStandardWebTestNewResourceModel{}
}

func (ApplicationInsightsStandardWebTestNewResource) ResourceType() string {
	return "azurerm_application_insights_standard_web_test_new"
}

func (r ApplicationInsightsStandardWebTestNewResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			var model ApplicationInsightsStandardWebTestNewResourceModel
			...
			validations := expandApplicationInsightsStandardWebTestNewValidations(model.ValidationRules)
			...
			props := webtests.WebTestProperties{
				...
				Locations:          expandApplicationInsightsStandardWebTestNewGeoLocations(model.GeoLocations),
				ValidationRules:    pointer.To(validations),
				Request:            r.expandApplicationInsightsStandardWebTestNewRequest(model.Request),
			}
...
func (r ApplicationInsightsStandardWebTestNewResource) Update() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 30 * time.Minute,
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			model := ApplicationInsightsStandardWebTestNewResourceModel{
				Name:              id.WebTestName,
			...
			props.Locations = expandApplicationInsightsStandardWebTestNewGeoLocations(model.GeoLocations)

			if metadata.ResourceData.HasChange("request") {
				props.Request = r.expandApplicationInsightsStandardWebTestNewRequest(model.Request)
			}

			if metadata.ResourceData.HasChange("validation_rules") {
				props.ValidationRules = pointer.To(expandApplicationInsightsStandardWebTestNewValidations(model.ValidationRules))
			}
...
func (ApplicationInsightsStandardWebTestNewResource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 5 * time.Minute,
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			state := ApplicationInsightsStandardWebTestNewResourceModel{
				Name:              id.WebTestName,
				ResourceGroupName: id.ResourceGroupName,
			}
			...
			if model := resp.Model; model != nil {
				...
				if props := model.Properties; props != nil {
					...
					req, err := flattenApplicationInsightsStandardWebTestNewRequest(props.Request)
					if err != nil {
						return fmt.Errorf("flattening request for %s: %+v", *id, err)
					}
					state.Request = req
					state.ValidationRules = flattenApplicationInsightsStandardWebTestNewValidations(props.ValidationRules)
					state.GeoLocations = flattenApplicationInsightsStandardWebTestNewGeoLocations(props.Locations)
				}
			}
...
func (ApplicationInsightsStandardWebTestNewResource) Delete() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 30 * time.Minute,
...
func (ApplicationInsightsStandardWebTestNewResource) IDValidationFunc() pluginsdk.SchemaValidateFunc {
	return webtests.ValidateWebTestID
}

func (ApplicationInsightsStandardWebTestNewResource) expandApplicationInsightsStandardWebTestNewRequest(input []RequestModel) (request *webtests.WebTestPropertiesRequest) {
	if len(input) == 0 {
		return nil
	}
	...
	request.Headers = expandApplicationInsightsStandardWebTestNewRequestHeaders(requestInput.Header)
...
func expandApplicationInsightsStandardWebTestNewRequestHeaders(input []HeaderModel) *[]webtests.HeaderField {
	if len(input) == 0 {
		return nil
	}
...
func flattenApplicationInsightsStandardWebTestNewRequest(input *webtests.WebTestPropertiesRequest) ([]RequestModel, error) {
	if input == nil {
	...
	result := RequestModel{
		...
		Header:                 flattenApplicationInsightsStandardWebTestNewRequestHeaders(req.Headers),
	}
...
func flattenApplicationInsightsStandardWebTestNewRequestHeaders(input *[]webtests.HeaderField) []HeaderModel {
...
func flattenApplicationInsightsStandardWebTestNewValidations(input *webtests.WebTestPropertiesValidationRules) []ValidationRuleModel {
	if input == nil {
	...
	result := ValidationRuleModel{
		...
		Content:                      flattenApplicationInsightsStandardWebTestNewContentValidations(rules.ContentValidation),
	}

	return []ValidationRuleModel{result}
}

func flattenApplicationInsightsStandardWebTestNewContentValidations(input *webtests.WebTestPropertiesValidationRulesContentValidation) []ContentModel {
	if input == nil {
		return []ContentModel{}
	}
...
func expandApplicationInsightsStandardWebTestNewValidations(input []ValidationRuleModel) webtests.WebTestPropertiesValidationRules {
	...
	rules.ContentValidation = expandApplicationInsightsStandardWebTestNewContentValidations(validationsInput.Content)

	return rules
}

func expandApplicationInsightsStandardWebTestNewContentValidations(input []ContentModel) *webtests.WebTestPropertiesValidationRulesContentValidation {
	if len(input) == 0 {
		return nil
	}
...
func expandApplicationInsightsStandardWebTestNewGeoLocations(input []string) []webtests.WebTestGeolocation {
	if len(input) == 0 {
...
func flattenApplicationInsightsStandardWebTestNewGeoLocations(input []webtests.WebTestGeolocation) []string {
